...
export const BoxPaperTitled: FC<BoxPaperTitledProps> = ({ containerSx = {}, children, title, sx = {}, ...boxProps }) => {
  const { primaryPalette } = usePalette();

  return (
    <Box sx={{ width: '100%', bgcolor: "white", borderRadius: "5px", boxShadow: "0px 0px 5px rgba(0,0,5,.1)", ...sx }} {...boxProps}>
