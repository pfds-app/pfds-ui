...
export type RestUserGenderEnum =
  (typeof RestUserGenderEnum)[keyof typeof RestUserGenderEnum];
...
export const UsersApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getUserById(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<RestUser>
    > {
